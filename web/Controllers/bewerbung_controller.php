...
class bewerbung_controller
{
    ...
    //WENN KEIN NACHRUECKVERFAHREN KATIV IST
    ...
    public function Belegwunschformular($modul_id)
    {
        $verfuegbar = "Verfügbar";
        $statement_modul = $this->modul->getModulBezeichnungKategorie($modul_id);
        $statement_modul->bind_result($modulbezeichnung, $kategorie);
        $statement_modul->store_result();
        ...
        while($statement_modul->fetch())
        {
            echo"<div style='margin-bottom: 100px;' class='form_thema'>";
            echo"<form method='post'>"; 
            echo "<h5>Bewerbungsmodul: {$modulbezeichnung}</h5>";
            echo "<h6>Bewerbungsverfahren</h6><br>";
            echo"<table>";   
            echo"<tr>";
            echo"<td style='width: 40%'><label for='Vornameame'><b>Vorname:</b><red style='color: red'>*</red></label></td>";
            echo"<td style='width: 60%'><input style='width: 100%' type='text class='form-control' id='Vorname'  placeholder='Vorname' required> </td>";
            echo "</tr> ";
            echo"<tr>";
            echo"<td style='width: 40%'><label for='Nachname'><b>Nachname:</b><red style='color: red'>*</red></label></td>";
            echo"<td style='width: 60%'><input style='width: 100%' type='text class='form-control' id='Nachname'  placeholder='Nachname' required> </td>";
            echo "</tr> ";
            echo"<tr>";
            echo"<td style='width: 30%'><label for='matrikelnummer'><b>Matrikelnummer:</b><red style='color: red'>*</red></label></td>";
            echo"<td style='width: 65%'><input style='width: 100%' type='text class='form-control' id='Matrikelnummer' required></td>";
            echo "</tr>";
    
            echo"<tr>";
            echo"<td style='width: 30%'><label for='E-Mail'><b>E-Mail:</b><red style='color: red'>*</red></label></td>";
            echo"<td style='width: 65%'><input style='width: 100%' type='text class='form-control' id='Email' placeholder='@stud.uni-goettingen.de' required></td>";
            echo "</tr>";
            echo"<tr>";
            echo"<td style='width: 30%'><label for='Fachsemester'><b>Aktuelles Fachsemester:</b><red style='color: red'>*</red></label></td>";
            echo"<td style='width: 65%'><input style='width: 100%' type='text class='form-control' id='Fachsemester' required></td>";
            echo "</tr>";
            echo"</table><br>";
            ...
            echo"<tr>";
            echo"<td style='width: 33%'><label for='Credits'><b>Anzahl Credits:</b><red style='color: red'>*</red></label></td>";
            echo"<td><input style='width: 75%;' type='text class='form-control' id='Credits_Anzahl' placeholer='Anzahl' required></td>";
            echo "</tr>";
            echo"<tr>";
            echo"<td style='width: 33%'><label for='Thema'><b>Thema 1:</b><red style='color: red'>*</red></label></td>";
            echo"<td>";
            echo"<select style='width: 75%;' class='form-control' id='Thema1' required>";
            ...
            echo"<td>";
            echo"<select style='width: 75%;' class='form-control' id='Thema2' required>";
            ...
            echo"<td>";
            echo"<select style='width: 75%;' class='form-control' id='Thema3' required>";
